...
export function BloomTimeline({ region, className }: Props) {
  ...
  return (
    <div className={cn("space-y-2", className)}>
      {/* 프로그레스 바 */}
      <div className="relative h-2 rounded-full bg-sakura-800">
        <div
        ...
        />
        <div className="absolute top-1/2 left-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-sakura-900 bg-[#ff4da6] shadow-sm" />
      </div>
