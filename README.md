...
- **기상청 vs AI 개화 비교** — 전국 16개 지역의 기상청 예보 + Gemini 2.5 Flash AI 예측 날짜를 나란히 표시
- **낙화 위험도** — Open-Meteo 날씨 데이터(강수량·풍속·돌풍) 기반 실시간 위험도 산출
- **AI 버꼬** — Gemma 3 27B 기반 AI 챗봇, 현재 개화 현황에 맞춘 여행지 추천
...
AI 예측은 Gemini 2.5 Flash가 3시간마다 전국 16개 지역의 개화·만개·낙화 날짜를 예측합니다. 결과는 인메모리 + 파일 캐시로 관리되어 dev 서버 재시작 시에도 즉시 로드됩니다.
